...
sample.labels <- fread("metadata/Aggregate_Human1_2.csv")
data.path <- dirout("07_03_CleanHuman_CleanSpikeIns/CorrectedData.RData")
outS <- "10_H_01_Seurat/"
...
cellsToKeep <- row.names(subset(pbmc@meta.data, res.0.5 %in% as.character(c(0:4,12:14))))
