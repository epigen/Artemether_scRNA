...
(load(dirout("10_H_01_Seurat/SeuratObject.RData")))
inDirFull <- "10_H_01_Seurat/"
...
# Spike ins
meta.spikeIns <- fread(list.files(dirout("07_03_CleanHuman_CleanSpikeIns/"), pattern="Cont.Genes.Data.+tsv", full.names=T))
...
metaFull[ celltype == "5",celltype := "Ductal"]
metaFull[ celltype == "10",celltype := "SI_human"] # CD3
metaFull[ celltype == "6",celltype := "Endothelial1"] # SPARC
metaFull[ celltype == "9",celltype := "Endothelial2"] # SPARC
